...
// Validate checks the field values on MinimalFileMeta with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *MinimalFileMeta) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MinimalFileMeta with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MinimalFileMetaMultiError, or nil if none found.
func (m *MinimalFileMeta) ValidateAll() error {
	return m.validate(true)
}

func (m *MinimalFileMeta) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, MinimalFileMetaValidationError{
					field:  "FileMeta",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return MinimalFileMetaValidationError{
				field:  "FileMeta",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return MinimalFileMetaMultiError(errors)
	}

	return nil
}

// MinimalFileMetaMultiError is an error wrapping multiple validation errors
// returned by MinimalFileMeta.ValidateAll() if the designated constraints
// aren't met.
type MinimalFileMetaMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MinimalFileMetaMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MinimalFileMetaMultiError) AllErrors() []error { return m }

// MinimalFileMetaValidationError is the validation error returned by
// MinimalFileMeta.Validate if the designated constraints aren't met.
type MinimalFileMetaValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MinimalFileMetaValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MinimalFileMetaValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MinimalFileMetaValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MinimalFileMetaValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MinimalFileMetaValidationError) ErrorName() string { return "MinimalFileMetaValidationError" }

// Error satisfies the builtin error interface
func (e MinimalFileMetaValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMinimalFileMeta.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MinimalFileMetaValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MinimalFileMetaValidationError{}
