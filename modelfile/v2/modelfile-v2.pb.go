...
type ModelFile_FileInfo struct {
	...
	NetworkVersion           *file_metadata.Version         `protobuf:"bytes,7,opt,name=network_version,json=networkVersion,proto3" json:"network_version,omitempty"`
	RuntimeVersion           *file_metadata.Version         `protobuf:"bytes,8,opt,name=runtime_version,json=runtimeVersion,proto3" json:"runtime_version,omitempty"`
	...
	NetworkSnapshotTimestamp int64                          `protobuf:"varint,10,opt,name=network_snapshot_timestamp,json=networkSnapshotTimestamp,proto3" json:"network_snapshot_timestamp,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *ModelFile_FileInfo) GetNetworkVersion() *file_metadata.Version {
	if x != nil {
...
func (x *ModelFile_FileInfo) GetRuntimeVersion() *file_metadata.Version {
	if x != nil {
...
const file_modelfile_v2_proto_rawDesc = "" +
	"\n" +
	"\x12modelfile-v2.proto\x12\fmodelfile.v2\x1a\x0evalidate.proto\x1a\x13file_metadata.proto\"\xf2*\n" +
	"\tModelFile\x12G\n" +
	...
	"DT_OCR_CTC\x10\n" +
	"B\x1b\n" +
	"\x19_ocr_decoding_information\x1a\x91\b\n" +
	"\bFileInfo\x12!\n" +
	...
	"\x0enetwork_flavor\x18\x06 \x01(\tR\rnetworkFlavor\x12?\n" +
	"\x0fnetwork_version\x18\a \x01(\v2\x16.file_metadata.VersionR\x0enetworkVersion\x12?\n" +
	"\x0fruntime_version\x18\b \x01(\v2\x16.file_metadata.VersionR\x0eruntimeVersion\x12H\n" +
	"\tprecision\x18\t \x01(\x0e2*.modelfile.v2.ModelFile.FileInfo.PrecisionR\tprecision\x12<\n" +
	"\x1anetwork_snapshot_timestamp\x18\n" +
	" \x01(\x03R\x18networkSnapshotTimestamp\"\xc0\x01\n" +
...
var file_modelfile_v2_proto_goTypes = []any{
	...
	(*file_metadata.Version)(nil),                                                                 // 25: file_metadata.Version
}
var file_modelfile_v2_proto_depIdxs = []int32{
	...
	25, // 13: modelfile.v2.ModelFile.FileInfo.network_version:type_name -> file_metadata.Version
	25, // 14: modelfile.v2.ModelFile.FileInfo.runtime_version:type_name -> file_metadata.Version
	4,  // 15: modelfile.v2.ModelFile.FileInfo.precision:type_name -> modelfile.v2.ModelFile.FileInfo.Precision
	22, // 16: modelfile.v2.ModelFile.FileContent.default_model:type_name -> modelfile.v2.ModelFile.FileContent.DefaultModel
	23, // 17: modelfile.v2.ModelFile.FileContent.tensorrt_model:type_name -> modelfile.v2.ModelFile.FileContent.TensorRTModel
	1,  // 18: modelfile.v2.ModelFile.Content.KeySlot.wrapping_method:type_name -> modelfile.v2.ModelFile.Content.EncryptionMethod
	14, // 19: modelfile.v2.ModelFile.Content.KeySlotsEntry.value:type_name -> modelfile.v2.ModelFile.Content.KeySlot
	17, // 20: modelfile.v2.ModelFile.InputFormatInformation.Input.image_format:type_name -> modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat
	18, // 21: modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.exact_image_size:type_name -> modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.ExactImageSizeRequirement
	19, // 22: modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.divisible_image_size:type_name -> modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.DivisibleImageSizeRequirement
	9,  // 23: modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.region_of_interest:type_name -> modelfile.v2.ModelFile.RegionFromEdge
	8,  // 24: modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.ExactImageSizeRequirement.image_size:type_name -> modelfile.v2.ModelFile.ImageSize
	8,  // 25: modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.DivisibleImageSizeRequirement.image_size_divisors:type_name -> modelfile.v2.ModelFile.ImageSize
	8,  // 26: modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.DivisibleImageSizeRequirement.minimum_image_size:type_name -> modelfile.v2.ModelFile.ImageSize
	8,  // 27: modelfile.v2.ModelFile.InputFormatInformation.Input.ImageInputFormat.DivisibleImageSizeRequirement.suggested_image_size:type_name -> modelfile.v2.ModelFile.ImageSize
	21, // 28: modelfile.v2.ModelFile.OutputDecodingInformation.OcrDecodingInformation.format_restrictions:type_name -> modelfile.v2.ModelFile.OutputDecodingInformation.OcrDecodingInformation.FormatRestrictionBlock
	6,  // 29: modelfile.v2.ModelFile.FileContent.DefaultModel.model_data:type_name -> modelfile.v2.ModelFile.Content
	6,  // 30: modelfile.v2.ModelFile.FileContent.TensorRTModel.model_data:type_name -> modelfile.v2.ModelFile.Content
	6,  // 31: modelfile.v2.ModelFile.FileContent.TensorRTModel.calibration_cache:type_name -> modelfile.v2.ModelFile.Content
	6,  // 32: modelfile.v2.ModelFile.FileContent.TensorRTModel.calibration_flatbuffers:type_name -> modelfile.v2.ModelFile.Content
