...
func UnmarshalJSONTargetSizeSource(data []byte) (TargetSizeSource, error) {
	...
	switch finder.Type {
	case "image_size":
		var concrete TargetSizeSourceImageSize
		if err := json.Unmarshal(data, &concrete); err != nil {
			return nil, fmt.Errorf("error unmarshaling into TargetSizeSourceImageSize: %w", err)
		}
		return &concrete, nil
	case "topic":
		var concrete TargetSizeSourceTopic
		if err := json.Unmarshal(data, &concrete); err != nil {
			return nil, fmt.Errorf("error unmarshaling into TargetSizeSourceTopic: %w", err)
		}
		return &concrete, nil
	default:
...
func UnmarshalJSONThresholdSource(data []byte) (ThresholdSource, error) {
	...
	switch finder.Type {
	case "topic":
		var concrete ThresholdSourceTopic
		if err := json.Unmarshal(data, &concrete); err != nil {
			return nil, fmt.Errorf("error unmarshaling into ThresholdSourceTopic: %w", err)
		}
		return &concrete, nil
	case "value":
		var concrete ThresholdSourceValue
		if err := json.Unmarshal(data, &concrete); err != nil {
			return nil, fmt.Errorf("error unmarshaling into ThresholdSourceValue: %w", err)
		}
		return &concrete, nil
	default:
...
// TargetSizeSourceImageSize corresponds to the JSON schema definition 'TargetSizeSourceImageSize'.
// Target size from an ImageSize constant.
type TargetSizeSourceImageSize struct {
	Size       ImageSize `json:"size"`
	SourceType string    `json:"source_type"`
}

// isTargetSizeSource implements the TargetSizeSource interface.
func (t *TargetSizeSourceImageSize) isTargetSizeSource() {}

// NewTargetSizeSourceImageSize creates a new instance of TargetSizeSourceImageSize with required fields.
// Optional fields should be set using builder methods.
func NewTargetSizeSourceImageSize(size ImageSize) *TargetSizeSourceImageSize {
	t := &TargetSizeSourceImageSize{
		Size:       size,
...
// TargetSizeSourceTopic corresponds to the JSON schema definition 'TargetSizeSourceTopic'.
// Target size from a topic source.
type TargetSizeSourceTopic struct {
	SourceType string `json:"source_type"`
	Topic      string `json:"topic"`
}

// isTargetSizeSource implements the TargetSizeSource interface.
func (t *TargetSizeSourceTopic) isTargetSizeSource() {}

// NewTargetSizeSourceTopic creates a new instance of TargetSizeSourceTopic with required fields.
// Optional fields should be set using builder methods.
func NewTargetSizeSourceTopic(topic string) *TargetSizeSourceTopic {
	t := &TargetSizeSourceTopic{
		Topic:      topic,
		SourceType: "topic",
	}
	return t
...
// ThresholdSourceTopic corresponds to the JSON schema definition 'ThresholdSourceTopic'.
// Threshold from a topic source.
type ThresholdSourceTopic struct {
	SourceType string `json:"source_type"`
	Topic      string `json:"topic"`
}

// isThresholdSource implements the ThresholdSource interface.
func (t *ThresholdSourceTopic) isThresholdSource() {}

// NewThresholdSourceTopic creates a new instance of ThresholdSourceTopic with required fields.
// Optional fields should be set using builder methods.
func NewThresholdSourceTopic(topic string) *ThresholdSourceTopic {
	t := &ThresholdSourceTopic{
		Topic:      topic,
		SourceType: "topic",
	}
	return t
...
// ThresholdSourceValue corresponds to the JSON schema definition 'ThresholdSourceValue'.
// Threshold from a constant value.
type ThresholdSourceValue struct {
	SourceType string  `json:"source_type"`
	Value      float64 `json:"value"`
}

// isThresholdSource implements the ThresholdSource interface.
func (t *ThresholdSourceValue) isThresholdSource() {}

// NewThresholdSourceValue creates a new instance of ThresholdSourceValue with required fields.
// Optional fields should be set using builder methods.
func NewThresholdSourceValue(value float64) *ThresholdSourceValue {
	t := &ThresholdSourceValue{
		Value:      value,
		SourceType: "value",
	}
	return t
