...
//
//    ocrPrediction, err := UnmarshalOcrPrediction(bytes)
//    bytes, err = ocrPrediction.Marshal()

package ocr_prediction

import "encoding/json"

func UnmarshalOcrPrediction(data []byte) (OcrPrediction, error) {
	var r OcrPrediction
	err := json.Unmarshal(data, &r)
	return r, err
}

func (r *OcrPrediction) Marshal() ([]byte, error) {
