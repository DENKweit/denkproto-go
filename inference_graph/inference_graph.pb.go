...
func (x *GenerateNumberNode) GetMin() uint32 {
	if x != nil {
		return x.Min
	}
	return 0
...
func (x *GenerateNumberNode) GetMax() uint32 {
	if x != nil {
		return x.Max
	}
	return 0
...
func (x *Graph) GetCreatedAt() uint32 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *ConstTensorNode_Uint64Array) GetData() []uint32 {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *ConstTensorNode_Int64Array) GetData() []int32 {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_inference_graph_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x20, 0x0a, 0x0a, 0x49,
	0x6e, 0x74, 0x36, 0x34, 0x41, 0x72, 0x72, 0x61, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x11, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x22, 0x0a,
	...
	0x28, 0x09, 0x52, 0x09, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x49, 0x64, 0x42, 0x3a, 0x5a,
	0x1c, 0x64, 0x65, 0x6e, 0x6b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d, 0x67, 0x6f, 0x2f, 0x69, 0x6e,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x5f, 0x67, 0x72, 0x61, 0x70, 0x68, 0xaa, 0x02, 0x19,
	0x44, 0x45, 0x4e, 0x4b, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x49, 0x6e, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x47, 0x72, 0x61, 0x70, 0x68, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
